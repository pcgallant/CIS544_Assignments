...
// Exercise 7_2 - Access class member functions through pointers MAIN
// Patricia Gallant
...
int main() {
   ...
   Time * ptrT = &t;  //create pointer to the object t

   displayTime("Initial time:", *ptrT); // display t's initial value
   ptrT->setTime(13, 27, 6); // change time
   displayTime("After setTime:", *ptrT); // display t's new value
